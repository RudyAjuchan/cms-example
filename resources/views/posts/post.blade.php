    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="rounded-sm border border-stroke bg-white px-5  pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-14">
            <div class="flex justify-end" id="btn-new">
                <a href="/posts/create" class="inline-flex items-center justify-center rounded-md bg-primary py-2 px-5 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @elseif($PO['publicado']==0)
                                    <span class="text-white bg-danger px-2 py-1 rounded-lg"><b>No</b></span>
                                @endif
                            </td>
                            <td class="text-center">
                                <form method="POST" action="/posts/{{$PO['id']}}" name="formD" id="formD" style="display:none">
                                    @method('DELETE')
                                    @csrf
                                    <button style="heigth:0px" id="buttonSubmit{{ $PO['id'] }}"></button>
                                </form>
                                <button type="button" 
                                    ...
                                    onclick="eliminar({{$PO['id']}})"
                                    >
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                <a href="/posts/{{$PO['id']}}/edit" class="inline-flex items-center justify-center rounded-md bg-warning py-2 px-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-2 xl:px-2">
            ...
            <div class="papelera">
                <table id="table_data2" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($postsPapelera as $POP)
                        <tr>
                            <td>{{ $POP['id'] }}</td>
                            <td>{{ $POP['id'] }}</td>
                            <td>{{ $POP['nombre'] }}</td>
                            <td class="text-center">
                                <form method="POST" action="/posts/restore/{{$POP['id']}}" name="formR" id="formR" style="display:none">
                                    @csrf
                                    <button style="heigth:0px" id="buttonSubmitR{{ $POP['id'] }}"></button>
                                </form>
                                <button type="button" 
